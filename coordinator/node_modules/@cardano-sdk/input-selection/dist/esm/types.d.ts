...
export declare type ProtocolParametersForInputSelection = Pick<Cardano.ProtocolParameters, 'coinsPerUtxoByte' | 'maxTxSize' | 'maxValueSize' | 'minFeeCoefficient' | 'minFeeConstant' | 'prices' | 'minFeeRefScriptCostPerByte'>;
