...
import { addTokenMaps, isValidValue, sortByCoins, stubMaxSizeAddress } from '../util.js';
...
export const adjustOutputsForFee = async (changeLovelace, constraints, inputs, outputs, changeOutputs, currentFee) => {
...
export const splitChangeAndComputeFee = async (inputs, outputs, changeLovelace, changeAssets, constraints, getChangeAddresses, fee) => {
