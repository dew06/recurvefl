import { HD_WALLET_CIP_ID, MULTISIG_CIP_ID } from '@cardano-sdk/core';
export var CardanoKeyConst;
...
})(CardanoKeyConst || (CardanoKeyConst = {}));
export var Cip1852PathLevelIndexes;
...
})(Cip1852PathLevelIndexes || (Cip1852PathLevelIndexes = {}));
export var KeyAgentType;
...
(function (KeyPurpose) {
    KeyPurpose[KeyPurpose["STANDARD"] = HD_WALLET_CIP_ID] = "STANDARD";
    KeyPurpose[KeyPurpose["MULTI_SIG"] = MULTISIG_CIP_ID] = "MULTI_SIG";
...
export const TxInId = ({ txId, index }) => `${txId}_${index}`;
