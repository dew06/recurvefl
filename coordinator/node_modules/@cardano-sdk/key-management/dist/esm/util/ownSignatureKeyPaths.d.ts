...
import { AccountKeyDerivationPath, GroupedAddress, TxInId, TxInKeyPathMap } from '../types.js';
...
export declare const ownSignatureKeyPaths: (txBody: Cardano.TxBody, knownAddresses: GroupedAddress[], txInKeyPathMap: TxInKeyPathMap, dRepKeyHash?: Crypto.Ed25519KeyHashHex, scripts?: Cardano.Script[]) => AccountKeyDerivationPath[];
export {};
