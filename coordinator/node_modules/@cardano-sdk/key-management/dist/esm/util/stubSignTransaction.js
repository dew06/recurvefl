...
export const stubSignTransaction = async ({ txBody, context: { knownAddresses, txInKeyPathMap, dRepKeyHashHex: dRepKeyHash, scripts }, signTransactionOptions: { extraSigners, additionalKeyPaths = [] } = {} }) => {
    ...
    const signatureKeyPaths = uniqWith([...ownSignatureKeyPaths(txBody, knownAddresses, txInKeyPathMap, dRepKeyHash, scripts), ...additionalKeyPaths], deepEquals);
