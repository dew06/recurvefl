...
const stubSignTransaction = async ({ txBody, context: { knownAddresses, txInKeyPathMap, dRepKeyHashHex: dRepKeyHash, scripts }, signTransactionOptions: { extraSigners, additionalKeyPaths = [] } = {} }) => {
    ...
    const signatureKeyPaths = (0, uniqWith_js_1.default)([...(0, ownSignatureKeyPaths_1.ownSignatureKeyPaths)(txBody, knownAddresses, txInKeyPathMap, dRepKeyHash, scripts), ...additionalKeyPaths], util_1.deepEquals);
