...
export declare class InMemoryKeyAgent extends KeyAgentBase implements KeyAgent {
    ...
    signTransaction(txBody: Serialization.TransactionBody, { txInKeyPathMap, knownAddresses, scripts }: SignTransactionContext, { additionalKeyPaths }?: SignTransactionOptions): Promise<Cardano.Signatures>;
